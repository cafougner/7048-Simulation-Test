...
public final class DrivetrainConstants {
    ...
    public static final SwerveModuleConfiguration kFLSwerveModuleConfiguration =
        new SwerveModuleConfiguration(1, 2, 3, new Translation2d(0.25, 0.25));

    public static final SwerveModuleConfiguration kFRSwerveModuleConfiguration =
        new SwerveModuleConfiguration(4, 5, 6, new Translation2d(0.25, -0.25));

    public static final SwerveModuleConfiguration kBLSwerveModuleConfiguration =
        new SwerveModuleConfiguration(7, 8, 9, new Translation2d(-0.25, 0.25));

    public static final SwerveModuleConfiguration kBRSwerveModuleConfiguration =
        new SwerveModuleConfiguration(10, 11, 12, new Translation2d(-0.25, -0.25));
